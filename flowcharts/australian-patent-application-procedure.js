/* ═══════════════════════════════════════════════════════════════════════
     ...
     CODE EMBED, per page — two lines:
       ...
       <script src="https://cdn.jsdelivr.net/gh/davidperkins2000/eureka@v0.3.10/flowcharts/australian-patent-application-procedure.js"></script>
...
'  ? PCT filing preserves rights in member states untiul 30 months',
...
'  ? Recommended request examination at filing. Can optionally be delayed, until directed by IP Australia.',
...
'  ? Establishes acceptance deadline of 12 months to resolve all objections to patentability.',
'Excess Claims Fees (if applicable) | | P0203A',
'  ? Payable when the application carries more than twenty claims.',
