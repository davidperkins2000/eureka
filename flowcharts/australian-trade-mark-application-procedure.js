/* ═══════════════════════════════════════════════════════════════════════
     EUREKA · flowcharts · australian-trade-mark-application-procedure · v1
     ...
     CODE EMBED, per page — two lines:
       <div data-eureka="australian-trade-mark-application-procedure"></div>
       <script src="https://cdn.jsdelivr.net/gh/davidperkins2000/eureka@v0.3.10/flowcharts/australian-trade-mark-application-procedure.js"></script>
...
var SLUG = 'australian-trade-mark-application-procedure';
...
var SPEC = [
'Priority Trade Mark Application | 0 months',
...
'Australian Registered Trade Mark Application Filed | 6 months | T0001',
'  ? Sets the applicant and the classes of goods and services.',
'Examination Report | 9\u201310 months| T0191',
...
'  ? Registration dates back to the filing date. The initial term runs ten years from filing.',
'Renewal Fees Due Every Ten Years | | T0010',
'  ? Renewable indefinitely in ten-year terms while the mark remains in use.'
].join('\n');
...
'    <svg role="img" aria-label="Australian trade mark application process"',
'         aria-describedby="au-tm-desc"></svg>',
'  </div>',
'</div>',
...
'</div>',
'<div class="eureka-sr">',
'  <p id="au-tm-desc">Procedural flowchart of an Australian trade mark',
'    application from pre-filing search through examination, response and',
'    acceptance to registration and ten-yearly renewal.</p>',
'</div>'
].join('\n');

var CLASSES = ['eureka', 'eureka--flow', 'eureka--au-trade-mark'];
